...
(0, ($parcel$interopDefault($TdzfH$webrtcadapter))).default || (0, ($parcel$interopDefault($TdzfH$webrtcadapter)));
...
var $6c02be62bb157391$export$f8f26dd395d7e1bd = /** @class */ function() {
    function Util() {
        ...
        this.browser = (0, $c2c6b21388937aac$export$25be9502477c137d).getBrowser();
        this.browserVersion = (0, $c2c6b21388937aac$export$25be9502477c137d).getVersion();
        /**
         ...
         */ this.supports = function() {
            var supported = {
                browser: (0, $c2c6b21388937aac$export$25be9502477c137d).isBrowserSupported(),
                webRTC: (0, $c2c6b21388937aac$export$25be9502477c137d).isWebRTCSupported(),
                audioVideo: false,
                data: false,
                binaryBlob: false,
                reliable: false
            ...
            try {
                ...
                try {
                    ...
                    try {
                        dc.binaryType = "blob";
                        supported.binaryBlob = !(0, $c2c6b21388937aac$export$25be9502477c137d).isIOS;
                    } catch (e) {}
                } catch (e) {} finally{
                    if (dc) dc.close();
                }
        ...
        this.pack = $TdzfH$peerjsjsbinarypack.pack;
        this.unpack = $TdzfH$peerjsjsbinarypack.unpack;
        // Binary stuff
        this._dataCount = 1;
    }
...
var $6c02be62bb157391$export$7debb50ef11d5e0b = new $6c02be62bb157391$export$f8f26dd395d7e1bd();


var $976f9b679211b81e$exports = {};

$parcel$export($976f9b679211b81e$exports, "Peer", () => $976f9b679211b81e$export$ecd1fc136c422448);


var $c25b565240b6a41d$exports = {};

$parcel$export($c25b565240b6a41d$exports, "LogLevel", () => $c25b565240b6a41d$export$243e62d78d3b544d);
$parcel$export($c25b565240b6a41d$exports, "default", () => $c25b565240b6a41d$export$2e2bcd8739ae039);
...
$parcel$export($a86db8d850e55bcf$exports, "Socket", () => $a86db8d850e55bcf$export$4798917dbf149b79);
 ...
 */ var $a86db8d850e55bcf$export$4798917dbf149b79 = /** @class */ function(_super) {
    $a86db8d850e55bcf$var$__extends(Socket, _super);
    ...
    Socket.prototype.start = function(id, token) {
        ...
        this._socket = new WebSocket(wsUrl + "&version=" + (0, $059935620e5e661f$exports.version));
        this._disconnected = false;
        this._socket.onmessage = function(event) {
            var data;
            try {
                data = JSON.parse(event.data);
                (0, $c25b565240b6a41d$exports.default).log("Server message received:", data);
            } catch (e) {
                (0, $c25b565240b6a41d$exports.default).log("Invalid server message", event.data);
                return;
            }
            _this.emit((0, $2f2cc37b22a0b29a$export$3b5c4a4b6354f023).Message, data);
        };
        this._socket.onclose = function(event) {
            if (_this._disconnected) return;
            (0, $c25b565240b6a41d$exports.default).log("Socket closed.", event);
            _this._cleanup();
            _this._disconnected = true;
            _this.emit((0, $2f2cc37b22a0b29a$export$3b5c4a4b6354f023).Disconnected);
        };
        ...
        this._socket.onopen = function() {
            ...
            (0, $c25b565240b6a41d$exports.default).log("Socket open");
    ...
    Socket.prototype._sendHeartbeat = function() {
        if (!this._wsOpen()) {
            (0, $c25b565240b6a41d$exports.default).log("Cannot send heartbeat, because socket closed");
            return;
        }
        var message = JSON.stringify({
            type: (0, $2f2cc37b22a0b29a$export$adb4a1754da6f10d).Heartbeat
        });
    ...
    /** Exposed send for DC & Peer. */ Socket.prototype.send = function(data) {
        ...
        if (!data.type) {
            this.emit((0, $2f2cc37b22a0b29a$export$3b5c4a4b6354f023).Error, "Invalid message");
            return;
        }
    ...
    return Socket;
}((0, $TdzfH$eventemitter3.EventEmitter));


var $9b5cc8dbdd0aa809$exports = {};

$parcel$export($9b5cc8dbdd0aa809$exports, "MediaConnection", () => $9b5cc8dbdd0aa809$export$4a84e95a2324ac29);


var $3b7b9afef381ead8$exports = {};

$parcel$export($3b7b9afef381ead8$exports, "Negotiator", () => $3b7b9afef381ead8$export$89e6bb5ad64bf4a);
 ...
 */ var $3b7b9afef381ead8$export$89e6bb5ad64bf4a = /** @class */ function() {
    ...
    /** Returns a PeerConnection object set up correctly (for data, media). */ Negotiator.prototype.startConnection = function(options) {
        ...
        if (this.connection.type === (0, $2f2cc37b22a0b29a$export$3157d57b4135e3bc).Media && options._stream) this._addTracksToConnection(options._stream, peerConnection);
        // What do we need to do now?
        if (options.originator) {
            if (this.connection.type === (0, $2f2cc37b22a0b29a$export$3157d57b4135e3bc).Data) {
    ...
    /** Start a PC. */ Negotiator.prototype._startPeerConnection = function() {
        (0, $c25b565240b6a41d$exports.default).log("Creating RTCPeerConnection.");
    ...
    /** Set up various WebRTC listeners. */ Negotiator.prototype._setupListeners = function(peerConnection) {
        ...
        // ICE CANDIDATES.
        (0, $c25b565240b6a41d$exports.default).log("Listening for ICE candidates.");
        peerConnection.onicecandidate = function(evt) {
            if (!evt.candidate || !evt.candidate.candidate) return;
            (0, $c25b565240b6a41d$exports.default).log("Received ICE candidates for ".concat(peerId, ":"), evt.candidate);
            provider.socket.send({
                type: (0, $2f2cc37b22a0b29a$export$adb4a1754da6f10d).Candidate,
                payload: {
        ...
        peerConnection.oniceconnectionstatechange = function() {
            switch(peerConnection.iceConnectionState){
                case "failed":
                    (0, $c25b565240b6a41d$exports.default).log("iceConnectionState is failed, closing connections to " + peerId);
                    _this.connection.emit("error", new Error("Negotiation of connection to " + peerId + " failed."));
                    _this.connection.close();
                    break;
                case "closed":
                    (0, $c25b565240b6a41d$exports.default).log("iceConnectionState is closed, closing connections to " + peerId);
                    _this.connection.emit("error", new Error("Connection to " + peerId + " closed."));
                    _this.connection.close();
                    break;
                case "disconnected":
                    (0, $c25b565240b6a41d$exports.default).log("iceConnectionState changed to disconnected on the connection with " + peerId);
                    break;
                case "completed":
                    peerConnection.onicecandidate = (0, $6c02be62bb157391$export$7debb50ef11d5e0b).noop;
                    break;
            }
            _this.connection.emit("iceStateChanged", peerConnection.iceConnectionState);
        };
        // DATACONNECTION.
        (0, $c25b565240b6a41d$exports.default).log("Listening for data channel");
        // Fired between offer and answer, so options should already be saved
        // in the options hash.
        peerConnection.ondatachannel = function(evt) {
            (0, $c25b565240b6a41d$exports.default).log("Received data channel");
            var dataChannel = evt.channel;
            var connection = provider.getConnection(peerId, connectionId);
            connection.initialize(dataChannel);
        };
        // MEDIACONNECTION.
        (0, $c25b565240b6a41d$exports.default).log("Listening for remote stream");
        peerConnection.ontrack = function(evt) {
            (0, $c25b565240b6a41d$exports.default).log("Received remote stream");
            var stream = evt.streams[0];
            var connection = provider.getConnection(peerId, connectionId);
            if (connection.type === (0, $2f2cc37b22a0b29a$export$3157d57b4135e3bc).Media) {
    ...
    Negotiator.prototype.cleanup = function() {
        (0, $c25b565240b6a41d$exports.default).log("Cleaning up PeerConnection to " + this.connection.peer);
        ...
        return $3b7b9afef381ead8$var$__awaiter(this, void 0, Promise, function() {
            ...
            return $3b7b9afef381ead8$var$__generator(this, function(_a) {
                switch(_a.label){
                    ...
                    case 2:
                        offer = _a.sent();
                        (0, $c25b565240b6a41d$exports.default).log("Created offer.");
                    ...
                    case 4:
                        _a.sent();
                        (0, $c25b565240b6a41d$exports.default).log("Set localDescription:", offer, "for:".concat(this.connection.peer));
                        payload = {
                            sdp: offer,
                            type: this.connection.type,
                            connectionId: this.connection.connectionId,
                            metadata: this.connection.metadata,
                            browser: (0, $6c02be62bb157391$export$7debb50ef11d5e0b).browser
                        };
                        if (this.connection.type === (0, $2f2cc37b22a0b29a$export$3157d57b4135e3bc).Data) {
                        ...
                        provider.socket.send({
                            type: (0, $2f2cc37b22a0b29a$export$adb4a1754da6f10d).Offer,
                            payload: payload,
                    ...
                    case 5:
                        ...
                        if (err_2 != "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer") {
                            provider.emitError((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).WebRTC, err_2);
                            (0, $c25b565240b6a41d$exports.default).log("Failed to setLocalDescription, ", err_2);
                        }
                        return [
                            3 /*break*/ ,
                            6
                    ...
                    case 7:
                        err_1_1 = _a.sent();
                        provider.emitError((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).WebRTC, err_1_1);
                        (0, $c25b565240b6a41d$exports.default).log("Failed to createOffer, ", err_1_1);
                        return [
                            3 /*break*/ ,
                            8
                        ];
        ...
        return $3b7b9afef381ead8$var$__awaiter(this, void 0, Promise, function() {
            ...
            return $3b7b9afef381ead8$var$__generator(this, function(_a) {
                switch(_a.label){
                    ...
                    case 2:
                        answer = _a.sent();
                        (0, $c25b565240b6a41d$exports.default).log("Created answer.");
                    ...
                    case 4:
                        _a.sent();
                        (0, $c25b565240b6a41d$exports.default).log("Set localDescription:", answer, "for:".concat(this.connection.peer));
                        provider.socket.send({
                            type: (0, $2f2cc37b22a0b29a$export$adb4a1754da6f10d).Answer,
                            payload: {
                                sdp: answer,
                                type: this.connection.type,
                                connectionId: this.connection.connectionId,
                    ...
                    case 5:
                        err_3 = _a.sent();
                        provider.emitError((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).WebRTC, err_3);
                        (0, $c25b565240b6a41d$exports.default).log("Failed to setLocalDescription, ", err_3);
                        return [
                            3 /*break*/ ,
                            6
                        ];
                    ...
                    case 7:
                        err_1_2 = _a.sent();
                        provider.emitError((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).WebRTC, err_1_2);
                        (0, $c25b565240b6a41d$exports.default).log("Failed to create answer, ", err_1_2);
                        return [
                            3 /*break*/ ,
                            8
                        ];
            ...
            return $3b7b9afef381ead8$var$__generator(this, function(_a) {
                switch(_a.label){
                    case 0:
                        ...
                        peerConnection = this.connection.peerConnection;
                        provider = this.connection.provider;
                        (0, $c25b565240b6a41d$exports.default).log("Setting remote description", sdp);
                        self = this;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([
                    ...
                    case 2:
                        _a.sent();
                        (0, $c25b565240b6a41d$exports.default).log("Set remoteDescription:".concat(type, " for:").concat(this.connection.peer));
                    ...
                    case 5:
                        err_4 = _a.sent();
                        provider.emitError((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).WebRTC, err_4);
                        (0, $c25b565240b6a41d$exports.default).log("Failed to setRemoteDescription, ", err_4);
                        return [
                            3 /*break*/ ,
                            6
                        ];
    ...
    /** Handle a candidate. */ Negotiator.prototype.handleCandidate = function(ice) {
        return $3b7b9afef381ead8$var$__awaiter(this, void 0, Promise, function() {
            ...
            return $3b7b9afef381ead8$var$__generator(this, function(_a) {
                switch(_a.label){
                    case 0:
                        (0, $c25b565240b6a41d$exports.default).log("handleCandidate:", ice);
                    ...
                    case 2:
                        _a.sent();
                        (0, $c25b565240b6a41d$exports.default).log("Added ICE candidate for:".concat(this.connection.peer));
                        return [
                            3 /*break*/ ,
                            4
                        ];
                    case 3:
                        err_5 = _a.sent();
                        provider.emitError((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).WebRTC, err_5);
                        (0, $c25b565240b6a41d$exports.default).log("Failed to handleCandidate, ", err_5);
                        return [
                            3 /*break*/ ,
                            4
                        ];
    ...
    Negotiator.prototype._addTracksToConnection = function(stream, peerConnection) {
        (0, $c25b565240b6a41d$exports.default).log("add tracks from stream ".concat(stream.id, " to peer connection"));
        if (!peerConnection.addTrack) return (0, $c25b565240b6a41d$exports.default).error("Your browser does't support RTCPeerConnection#addTrack. Ignored.");
        stream.getTracks().forEach(function(track) {
            peerConnection.addTrack(track, stream);
        });
    };
    Negotiator.prototype._addStreamToMediaConnection = function(stream, mediaConnection) {
        (0, $c25b565240b6a41d$exports.default).log("add stream ".concat(stream.id, " to media connection ").concat(mediaConnection.connectionId));
...
$parcel$export($816db5763b2092b1$exports, "BaseConnection", () => $816db5763b2092b1$export$23a2a68283c24d80);
...
var $816db5763b2092b1$export$23a2a68283c24d80 = /** @class */ function(_super) {
    $816db5763b2092b1$var$__extends(BaseConnection, _super);
 ...
 */ var $9b5cc8dbdd0aa809$export$4a84e95a2324ac29 = /** @class */ function(_super) {
    $9b5cc8dbdd0aa809$var$__extends(MediaConnection, _super);
    function MediaConnection(peerId, provider, options) {
        var _this = _super.call(this, peerId, provider, options) || this;
        _this._localStream = _this.options._stream;
        _this.connectionId = _this.options.connectionId || MediaConnection.ID_PREFIX + (0, $6c02be62bb157391$export$7debb50ef11d5e0b).randomToken();
        _this._negotiator = new (0, $3b7b9afef381ead8$exports.Negotiator)(_this);
    ...
    Object.defineProperty(MediaConnection.prototype, "type", {
         ...
         */ get: function() {
            return (0, $2f2cc37b22a0b29a$export$3157d57b4135e3bc).Media;
        },
        enumerable: false,
        configurable: true
    });
    ...
    MediaConnection.prototype.addStream = function(remoteStream) {
        (0, $c25b565240b6a41d$exports.default).log("Receiving stream", remoteStream);
     ...
     */ MediaConnection.prototype.handleMessage = function(message) {
        ...
        switch(message.type){
            case (0, $2f2cc37b22a0b29a$export$adb4a1754da6f10d).Answer:
                // Forward to negotiator
                this._negotiator.handleSDP(type, payload.sdp);
                this._open = true;
                break;
            case (0, $2f2cc37b22a0b29a$export$adb4a1754da6f10d).Candidate:
                this._negotiator.handleCandidate(payload.candidate);
                break;
            default:
                (0, $c25b565240b6a41d$exports.default).warn("Unrecognized message type:".concat(type, " from peer:").concat(this.peer));
                break;
        }
    };
    /**
     ...
     */ MediaConnection.prototype.answer = function(stream, options) {
        ...
        if (this._localStream) {
            (0, $c25b565240b6a41d$exports.default).warn("Local stream already exists on this MediaConnection. Are you answering a call twice?");
            return;
        }
...
}((0, $816db5763b2092b1$exports.BaseConnection));


var $92db9a3ba21db2a0$exports = {};

$parcel$export($92db9a3ba21db2a0$exports, "DataConnection", () => $92db9a3ba21db2a0$export$d365f7ad9d7df9c9);
...
$parcel$export($3ff0aafdb373378c$exports, "EncodingQueue", () => $3ff0aafdb373378c$export$c6913ae0ed687038);
...
var $3ff0aafdb373378c$export$c6913ae0ed687038 = /** @class */ function(_super) {
    $3ff0aafdb373378c$var$__extends(EncodingQueue, _super);
    function EncodingQueue() {
        ...
        _this.fileReader.onerror = function(evt) {
            (0, $c25b565240b6a41d$exports.default).error("EncodingQueue error:", evt);
            _this._processing = false;
            _this.destroy();
 ...
 */ var $92db9a3ba21db2a0$export$d365f7ad9d7df9c9 = /** @class */ function(_super) {
    $92db9a3ba21db2a0$var$__extends(DataConnection, _super);
    function DataConnection(peerId, provider, options) {
        ...
        _this._chunkedData = {};
        _this._encodingQueue = new (0, $3ff0aafdb373378c$exports.EncodingQueue)();
        _this.connectionId = _this.options.connectionId || DataConnection.ID_PREFIX + (0, $6c02be62bb157391$export$7debb50ef11d5e0b).randomToken();
        _this.label = _this.options.label || _this.connectionId;
        _this.serialization = _this.options.serialization || (0, $2f2cc37b22a0b29a$export$89f507cf986a947).Binary;
        _this.reliable = !!_this.options.reliable;
        _this._encodingQueue.on("done", function(ab) {
            _this._bufferedSend(ab);
        });
        _this._encodingQueue.on("error", function() {
            (0, $c25b565240b6a41d$exports.default).error("DC#".concat(_this.connectionId, ": Error occured in encoding from blob to arraybuffer, close DC"));
            _this.close();
        });
        _this._negotiator = new (0, $3b7b9afef381ead8$exports.Negotiator)(_this);
    ...
    Object.defineProperty(DataConnection.prototype, "type", {
        get: function() {
            return (0, $2f2cc37b22a0b29a$export$3157d57b4135e3bc).Data;
        },
        enumerable: false,
        configurable: true
    });
    ...
    DataConnection.prototype._configureDataChannel = function() {
        var _this = this;
        if (!(0, $6c02be62bb157391$export$7debb50ef11d5e0b).supports.binaryBlob || (0, $6c02be62bb157391$export$7debb50ef11d5e0b).supports.reliable) this.dataChannel.binaryType = "arraybuffer";
        this.dataChannel.onopen = function() {
            (0, $c25b565240b6a41d$exports.default).log("DC#".concat(_this.connectionId, " dc connection success"));
            _this._open = true;
            _this.emit("open");
        };
        this.dataChannel.onmessage = function(e) {
            (0, $c25b565240b6a41d$exports.default).log("DC#".concat(_this.connectionId, " dc onmessage:"), e.data);
            _this._handleDataMessage(e);
        };
        this.dataChannel.onclose = function() {
            (0, $c25b565240b6a41d$exports.default).log("DC#".concat(_this.connectionId, " dc closed for:"), _this.peer);
            _this.close();
        };
    };
    ...
    DataConnection.prototype._handleDataMessage = function(_a) {
        ...
        var isBinarySerialization = this.serialization === (0, $2f2cc37b22a0b29a$export$89f507cf986a947).Binary || this.serialization === (0, $2f2cc37b22a0b29a$export$89f507cf986a947).BinaryUTF8;
        var deserializedData = data;
        if (isBinarySerialization) {
            if (datatype === Blob) {
                // Datatype should never be blob
                (0, $6c02be62bb157391$export$7debb50ef11d5e0b).blobToArrayBuffer(data, function(ab) {
                    var unpackedData = (0, $6c02be62bb157391$export$7debb50ef11d5e0b).unpack(ab);
                    _this.emit("data", unpackedData);
                });
                return;
            } else if (datatype === ArrayBuffer) deserializedData = (0, $6c02be62bb157391$export$7debb50ef11d5e0b).unpack(data);
            else if (datatype === String) {
                // String fallback for binary data for browsers that don't support binary yet
                var ab = (0, $6c02be62bb157391$export$7debb50ef11d5e0b).binaryStringToArrayBuffer(data);
                deserializedData = (0, $6c02be62bb157391$export$7debb50ef11d5e0b).unpack(ab);
            }
        } else if (this.serialization === (0, $2f2cc37b22a0b29a$export$89f507cf986a947).JSON) deserializedData = this.parse(data);
     ...
     */ DataConnection.prototype.send = function(data, chunked) {
        ...
        if (this.serialization === (0, $2f2cc37b22a0b29a$export$89f507cf986a947).JSON) this._bufferedSend(this.stringify(data));
        else if (this.serialization === (0, $2f2cc37b22a0b29a$export$89f507cf986a947).Binary || this.serialization === (0, $2f2cc37b22a0b29a$export$89f507cf986a947).BinaryUTF8) {
            var blob = (0, $6c02be62bb157391$export$7debb50ef11d5e0b).pack(data);
            if (!chunked && blob.size > (0, $6c02be62bb157391$export$7debb50ef11d5e0b).chunkedMTU) {
                this._sendChunks(blob);
                return;
            }
            if (!(0, $6c02be62bb157391$export$7debb50ef11d5e0b).supports.binaryBlob) // We only do this if we really need to (e.g. blobs are not supported),
    ...
    DataConnection.prototype._trySend = function(msg) {
        ...
        try {
            ...
            (0, $c25b565240b6a41d$exports.default).error("DC#:".concat(this.connectionId, " Error when sending:"), e);
            this._buffering = true;
            this.close();
            return false;
        }
    ...
    DataConnection.prototype._sendChunks = function(blob) {
        var e_1, _a;
        var blobs = (0, $6c02be62bb157391$export$7debb50ef11d5e0b).chunk(blob);
        (0, $c25b565240b6a41d$exports.default).log("DC#".concat(this.connectionId, " Try to send ").concat(blobs.length, " chunks..."));
        try {
     ...
     */ DataConnection.prototype.handleMessage = function(message) {
        ...
        switch(message.type){
            ...
            case (0, $2f2cc37b22a0b29a$export$adb4a1754da6f10d).Candidate:
                ...
                break;
            default:
                (0, $c25b565240b6a41d$exports.default).warn("Unrecognized message type:", message.type, "from peer:", this.peer);
                break;
        }
    };
...
$parcel$export($067535f02cda23a2$exports, "API", () => $067535f02cda23a2$export$2c4e825dc9120f87);
...
var $067535f02cda23a2$export$2c4e825dc9120f87 = /** @class */ function() {
    ...
    API.prototype._buildRequest = function(method) {
        ...
        url.searchParams.set("version", (0, $059935620e5e661f$exports.version));
        ...
        return $067535f02cda23a2$var$__awaiter(this, void 0, Promise, function() {
            ...
            return $067535f02cda23a2$var$__generator(this, function(_a) {
                switch(_a.label){
                    ...
                    case 2:
                        error_1 = _a.sent();
                        (0, $c25b565240b6a41d$exports.default).error("Error retrieving ID", error_1);
                        pathError = "";
                        if (this._options.path === "/" && this._options.host !== (0, $6c02be62bb157391$export$7debb50ef11d5e0b).CLOUD_HOST) pathError = " If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer.";
        ...
        return $067535f02cda23a2$var$__awaiter(this, void 0, Promise, function() {
            ...
            return $067535f02cda23a2$var$__generator(this, function(_a) {
                switch(_a.label){
                    ...
                    case 1:
                        ...
                        if (response.status !== 200) {
                            if (response.status === 401) {
                                helpfulError = "";
                                if (this._options.host === (0, $6c02be62bb157391$export$7debb50ef11d5e0b).CLOUD_HOST) helpfulError = "It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key.";
                    ...
                    case 2:
                        error_2 = _a.sent();
                        (0, $c25b565240b6a41d$exports.default).error("Error retrieving list peers", error_2);
...
var $976f9b679211b81e$var$PeerError = /** @class */ function(_super) {
    $976f9b679211b81e$var$__extends(PeerError, _super);
 ...
 */ var $976f9b679211b81e$export$ecd1fc136c422448 = /** @class */ function(_super) {
    $976f9b679211b81e$var$__extends(Peer, _super);
    function Peer(id, options) {
        ...
        options = $976f9b679211b81e$var$__assign({
            debug: 0,
            host: (0, $6c02be62bb157391$export$7debb50ef11d5e0b).CLOUD_HOST,
            port: (0, $6c02be62bb157391$export$7debb50ef11d5e0b).CLOUD_PORT,
            path: "/",
            key: Peer.DEFAULT_KEY,
            token: (0, $6c02be62bb157391$export$7debb50ef11d5e0b).randomToken(),
            config: (0, $6c02be62bb157391$export$7debb50ef11d5e0b).defaultConfig,
        ...
        if (_this._options.secure === undefined && _this._options.host !== (0, $6c02be62bb157391$export$7debb50ef11d5e0b).CLOUD_HOST) _this._options.secure = (0, $6c02be62bb157391$export$7debb50ef11d5e0b).isSecure();
        else if (_this._options.host == (0, $6c02be62bb157391$export$7debb50ef11d5e0b).CLOUD_HOST) _this._options.secure = true;
        // Set a custom log function if present
        if (_this._options.logFunction) (0, $c25b565240b6a41d$exports.default).setLogFunction(_this._options.logFunction);
        (0, $c25b565240b6a41d$exports.default).logLevel = _this._options.debug || 0;
        _this._api = new (0, $067535f02cda23a2$exports.API)(options);
        _this._socket = _this._createServerConnection();
        // Sanity checks
        // Ensure WebRTC supported
        if (!(0, $6c02be62bb157391$export$7debb50ef11d5e0b).supports.audioVideo && !(0, $6c02be62bb157391$export$7debb50ef11d5e0b).supports.data) {
            _this._delayedAbort((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).BrowserIncompatible, "The current browser does not support WebRTC");
            return _this;
        }
        // Ensure alphanumeric id
        if (!!userId && !(0, $6c02be62bb157391$export$7debb50ef11d5e0b).validateId(userId)) {
            _this._delayedAbort((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).InvalidID, 'ID "'.concat(userId, '" is invalid'));
            return _this;
        }
        if (userId) _this._initialize(userId);
            ...
            return _this._abort((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).ServerError, error);
        });
        return _this;
    }
    ...
    Peer.prototype._createServerConnection = function() {
        var _this = this;
        var socket = new (0, $a86db8d850e55bcf$exports.Socket)(this._options.secure, this._options.host, this._options.port, this._options.path, this._options.key, this._options.pingInterval);
        socket.on((0, $2f2cc37b22a0b29a$export$3b5c4a4b6354f023).Message, function(data) {
            _this._handleMessage(data);
        });
        socket.on((0, $2f2cc37b22a0b29a$export$3b5c4a4b6354f023).Error, function(error) {
            _this._abort((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).SocketError, error);
        });
        socket.on((0, $2f2cc37b22a0b29a$export$3b5c4a4b6354f023).Disconnected, function() {
            if (_this.disconnected) return;
            _this.emitError((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).Network, "Lost connection to server.");
            _this.disconnect();
        });
        socket.on((0, $2f2cc37b22a0b29a$export$3b5c4a4b6354f023).Close, function() {
            if (_this.disconnected) return;
            _this._abort((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).SocketClosed, "Underlying socket is already closed.");
        });
        return socket;
    };
    ...
    /** Handles messages from the server. */ Peer.prototype._handleMessage = function(message) {
        ...
        switch(type){
            case (0, $2f2cc37b22a0b29a$export$adb4a1754da6f10d).Open:
                this._lastServerId = this.id;
                this._open = true;
                this.emit("open", this.id);
                break;
            case (0, $2f2cc37b22a0b29a$export$adb4a1754da6f10d).Error:
                this._abort((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).ServerError, payload.msg);
                break;
            case (0, $2f2cc37b22a0b29a$export$adb4a1754da6f10d).IdTaken:
                this._abort((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).UnavailableID, 'ID "'.concat(this.id, '" is taken'));
                break;
            case (0, $2f2cc37b22a0b29a$export$adb4a1754da6f10d).InvalidKey:
                this._abort((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).InvalidKey, 'API KEY "'.concat(this._options.key, '" is invalid'));
                break;
            case (0, $2f2cc37b22a0b29a$export$adb4a1754da6f10d).Leave:
                (0, $c25b565240b6a41d$exports.default).log("Received leave message from ".concat(peerId));
                this._cleanupPeer(peerId);
                this._connections.delete(peerId);
                break;
            case (0, $2f2cc37b22a0b29a$export$adb4a1754da6f10d).Expire:
                this.emitError((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).PeerUnavailable, "Could not connect to peer ".concat(peerId));
                var peerConnections = this._connections.get(peerId);
                if (peerConnections) peerConnections.forEach(function(conn) {
                    conn.emit("error", new $976f9b679211b81e$var$PeerError((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).PeerUnavailable, "Could not connect to peer ".concat(peerId)));
                });
                this._cleanupPeer(peerId);
                this._connections.delete(peerId);
                break;
            case (0, $2f2cc37b22a0b29a$export$adb4a1754da6f10d).Offer:
                // we should consider switching this to CALL/CONNECT, but this is the least breaking option.
                var connectionId = payload.connectionId;
                var connection = this.getConnection(peerId, connectionId);
                if (connection) {
                    connection.close();
                    (0, $c25b565240b6a41d$exports.default).warn("Offer received for existing Connection ID:".concat(connectionId));
                }
                // Create a new connection.
                if (payload.type === (0, $2f2cc37b22a0b29a$export$3157d57b4135e3bc).Media) {
                    var mediaConnection = new (0, $9b5cc8dbdd0aa809$exports.MediaConnection)(peerId, this, {
                        connectionId: connectionId,
                        _payload: payload,
                ...
                } else if (payload.type === (0, $2f2cc37b22a0b29a$export$3157d57b4135e3bc).Data) {
                    var dataConnection = new (0, $92db9a3ba21db2a0$exports.DataConnection)(peerId, this, {
                        connectionId: connectionId,
                        _payload: payload,
                        metadata: payload.metadata,
                        label: payload.label,
                    ...
                    (0, $c25b565240b6a41d$exports.default).warn("Received malformed connection type:".concat(payload.type));
                    return;
                }
                // Find messages.
            ...
            default:
                if (!payload) {
                    (0, $c25b565240b6a41d$exports.default).warn("You received a malformed message from ".concat(peerId, " of type ").concat(type));
                    return;
                }
                var connectionId = payload.connectionId;
                var connection = this.getConnection(peerId, connectionId);
                ...
                else (0, $c25b565240b6a41d$exports.default).warn("You received an unrecognized message:", message);
                break;
        }
    };
     ...
     */ Peer.prototype.connect = function(peer, options) {
        ...
        if (this.disconnected) {
            (0, $c25b565240b6a41d$exports.default).warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available.");
            this.emitError((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).Disconnected, "Cannot connect to new Peer after disconnecting from server.");
            return;
        }
        var dataConnection = new (0, $92db9a3ba21db2a0$exports.DataConnection)(peer, this, options);
     ...
     */ Peer.prototype.call = function(peer, stream, options) {
        if (options === void 0) options = {};
        if (this.disconnected) {
            (0, $c25b565240b6a41d$exports.default).warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect.");
            this.emitError((0, $2f2cc37b22a0b29a$export$9547aaa2e39030ff).Disconnected, "Cannot connect to new Peer after disconnecting from server.");
            return;
        }
        if (!stream) {
            (0, $c25b565240b6a41d$exports.default).error("To call a peer, you must provide a stream from your browser's `getUserMedia`.");
            return;
        }
        var mediaConnection = new (0, $9b5cc8dbdd0aa809$exports.MediaConnection)(peer, this, $976f9b679211b81e$var$__assign($976f9b679211b81e$var$__assign({}, options), {
            _stream: stream
        }));
    ...
    /** Add a data/media connection to this peer. */ Peer.prototype._addConnection = function(peerId, connection) {
        (0, $c25b565240b6a41d$exports.default).log("add connection ".concat(connection.type, ":").concat(connection.connectionId, " to peerId:").concat(peerId));
     ...
     */ Peer.prototype._abort = function(type, message) {
        (0, $c25b565240b6a41d$exports.default).error("Aborting!");
        this.emitError(type, message);
        if (!this._lastServerId) this.destroy();
        else this.disconnect();
    };
    /** Emits a typed error message. */ Peer.prototype.emitError = function(type, err) {
        (0, $c25b565240b6a41d$exports.default).error("Error:", err);
        this.emit("error", new $976f9b679211b81e$var$PeerError(type, err));
    };
    /**
     ...
     */ Peer.prototype.destroy = function() {
        ...
        (0, $c25b565240b6a41d$exports.default).log("Destroy peer with ID:".concat(this.id));
        this.disconnect();
        this._cleanup();
     ...
     */ Peer.prototype.disconnect = function() {
        ...
        (0, $c25b565240b6a41d$exports.default).log("Disconnect peer with ID:".concat(currentId));
        this._disconnected = true;
        this._open = false;
        this.socket.close();
     ...
     */ Peer.prototype.reconnect = function() {
        if (this.disconnected && !this.destroyed) {
            (0, $c25b565240b6a41d$exports.default).log("Attempting reconnection to server with ID ".concat(this._lastServerId));
            this._disconnected = false;
            this._initialize(this._lastServerId);
        } else if (this.destroyed) throw new Error("This peer cannot reconnect to the server. It has already been destroyed.");
        else if (!this.disconnected && !this.open) // Do nothing. We're still connecting the first time.
        (0, $c25b565240b6a41d$exports.default).error("In a hurry? We're still trying to make the initial connection!");
...
var $f1d1a6b5c376b066$export$2e2bcd8739ae039 = (0, $976f9b679211b81e$exports.Peer);
